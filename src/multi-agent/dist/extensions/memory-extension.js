...
function getMemoryFileJsonPath(agentId) {
...
async function readMemoryJson(agentId) {
...
async function writeMemoryJson(agentId, data) {
    await ensureMemoryDir();
    const jsonPath = getMemoryFileJsonPath(agentId);
    await fs.writeFile(jsonPath, JSON.stringify(data, null, 2), "utf-8");
}
function generateMemoryMarkdown(data) {
    if (!data)
        return "";
    let md = "# Memory\n> Auto-managed.\n\n";
    md += "## Core Learnings\n";
...
//# sourceMappingURL=memory-extension.js.map