...
export function CrmLayout() {
    ...
    const navItems = [
        { label: t('crm.guestList'), path: "/crm", icon: <Users className="h-4 w-4" /> },
        { label: t('crm.tiers'), path: "/crm/tiers", icon: <LayoutDashboard className="h-4 w-4" /> },
        { label: t('crm.analytics'), path: "/crm/analytics", icon: <BarChart3 className="h-4 w-4" /> },
        { label: t('crm.campaigns'), path: "/crm/campaigns", icon: <History className="h-4 w-4" /> },
        { label: t('common.settings'), path: "/crm/settings", icon: <Settings className="h-4 w-4" /> },
    ];
