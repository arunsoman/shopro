  ...
  return (
    <SecureOverlay>
      <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500 pb-24 text-slate-900 dark:text-white">
        ...
        <AnimatePresence>
          {isExploreOpen && (
            <div className="fixed inset-0 z-200 flex items-center justify-center p-6 bg-slate-950/20 backdrop-blur-sm animate-in fade-in duration-300">
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
              ...
              >
                <header className="p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
                  <div className="space-y-1">
                    <h3 className="text-3xl font-black tracking-tighter text-brand-primary uppercase italic">Marketplace Catalog</h3>
                    <p className="text-xs font-bold text-slate-400 tracking-widest uppercase">Source premium ingredients directly from our network</p>
                  </div>
        ...
        {getItemCount() > 0 && (
          <div className="fixed bottom-12 right-12 z-100">
             <button 
               ...
               className="h-20 w-20 bg-brand-primary text-slate-950 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-all border-4 border-white dark:border-slate-900 group"
             >
