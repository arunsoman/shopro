          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : variant === "indigo" ? shoproGradient : defaultGradient,
