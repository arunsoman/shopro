  ...
  if (!mounted) {
    return (
      <div className="relative inline-block">
        <div className="relative flex h-[38px] w-[68px] items-center rounded-full bg-gray-200 p-1" />
      </div>
    );
  }
  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative flex h-[38px] w-[68px] items-center rounded-full p-[4px] transition-all duration-300 focus:outline-none"
        style={{
          background: isDark
          ...
          boxShadow: isDark
            ? `
              ...
              inset -5px -5px 10px rgba(100, 116, 139, 0.2),
            ...
            : `
              ...
              inset 5px 5px 10px rgba(100, 116, 139, 0.3),
      ...
      >
        <div 
          ...
          style={{
            boxShadow: isDark
              ? 'inset 0 1px 3px rgba(0, 0, 0, 0.9), inset 0 -0.5px 1.5px rgba(71, 85, 105, 0.3)'
              : 'inset 0 1px 3px rgba(100, 116, 139, 0.4), inset 0 -0.5px 1.5px rgba(255, 255, 255, 0.8)',
          }}
        />
        ...
        <div className="absolute inset-0 flex items-center justify-between px-3">
          <Sun size={14} className={isDark ? 'text-yellow-100 opacity-40' : 'text-amber-600'} />
          <Moon size={14} className={isDark ? 'text-yellow-100' : 'text-slate-700 opacity-40'} />
        </div>

        <motion.div
          className="relative z-10 flex h-[30px] w-[30px] items-center justify-center rounded-full overflow-hidden"
          style={{
            background: isDark
