...
public interface TablesideSessionRepository extends JpaRepository<TablesideSession, UUID> {
    ...
    List<TablesideSession> findAllByStatus(TablesideSessionStatus status);
    List<TablesideSession> findAllByTableIdAndStatus(UUID tableId, TablesideSessionStatus status);
}
