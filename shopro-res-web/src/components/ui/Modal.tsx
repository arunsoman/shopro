...
>(({ className, children, ...props }, ref) => (
    <ModalPortal>
        ...
        >
            {children}
            <ModalPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-muted/10 data-[state=open]:text-muted-foreground">
                <X className="h-4 w-4" />
