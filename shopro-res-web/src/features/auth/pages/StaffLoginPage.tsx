...
export default function StaffLoginPage() {
  const restaurantId = useAuthStore(s => s.restaurantId) || 3;

  return (
    <div className="w-full h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-start p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-2xl relative z-10 flex flex-col items-center flex-shrink-0">
        ...
        {/* Login Container */}
        <div className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl p-8 sm:p-10 shadow-2xl shadow-slate-200/50 dark:shadow-black/50 overflow-auto max-h-[70vh]">
