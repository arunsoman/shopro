...
import { useMultiLocationSummary } from "@/prime-cost/hooks/usePrimeCost";
import {
  C, fmt, fmtPct, fmtPts, pcColor, pcBg, GlobalStyles,
...
const MultiLocationPage: FC = () => {
  ...
  const query = useMultiLocationSummary(
    { weekStart, restaurantIds },
